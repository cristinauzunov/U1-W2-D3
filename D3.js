...
if (crewMass < 500){
    ...
    console.log('DANGER! OVERLOAD ALERT: escape from ship');
}
/* ESERCIZIO 8
...
*/
 ...
 const randomCharacter = starWarsCharacters[random]

 console.log(
  `Il personaggio selezionato è ${randomCharacter.name}. ` +
  `e alto ${randomCharacter.height} cm e pesa ${randomCharacter.mass} kg. ` +
  `Il colore dei suoi occhi è ${randomCharacter.eye_color} e i suoi capelli sono ${randomCharacter.hair_color}. ` +
  `È nato nel ${randomCharacter.birth_year}.`
 )